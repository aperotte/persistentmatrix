...
As of yet, the labels do not do much, but the intention is to eventually make a matrix a function of it's idices and/or labels.  For example, one might access an element in a 3-dimensional persistentmatrix like this (note: this functionality doesn't actually exist yet!):
